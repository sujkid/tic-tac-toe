...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameEvent = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onClickBox = function onClickBox(event) {
	  event.preventDefault();
	  if ($(this).text() === 'X' || $(this).text() === 'O' || gameOver === 'true' || typeof store.game === 'undefined' || store.user === null) {
	    return;
	  }
	...
	var onShowGames = function onShowGames(event) {
	  ...
	  // if (gameId.length === 0) {
	  api.index().then(ui.successShowGame).catch(ui.failure);
